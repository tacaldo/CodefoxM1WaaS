 ...
 * Use the [StartNavFragment.newInstance] factory method to
...
class StartNavFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_start_nav, container, false)

        view.findViewById<Button>(R.id.bttnFindJobs).setOnClickListener(
    ...
    companion object {
         ...
         * @return A new instance of fragment StartNavFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            StartNavFragment().apply {
